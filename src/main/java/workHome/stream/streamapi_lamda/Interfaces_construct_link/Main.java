package main.java.workHome.stream.streamapi_lamda.Interfaces_construct_link;
...
public class Main {
    public static void main(String[] args) {
        ...
        Database database = (name, password, seePass) -> new User(name, password, seePass); // создание ссылки на коструктор
